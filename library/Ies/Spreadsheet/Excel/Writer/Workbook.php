...
class Ies_Spreadsheet_Excel_Writer_Workbook extends Ies_Spreadsheet_Excel_Writer_BIFFwriter
{
    /**
    ...
    */
    function __construct($filename)
    {
        ...
        $this->_parser           =& new Ies_Spreadsheet_Excel_Writer_Parser($this->_byte_order, $this->_BIFF_version);
        $this->_1904             = 0;
        $this->_activesheet      = 0;
        $this->_firstsheet       = 0;
        $this->_selected         = 0;
        ...
        $this->_tmp_format       =& new Ies_Spreadsheet_Excel_Writer_Format($this->_BIFF_version);
...
/*        if ($this->isError($res)) {
    ...
    */
    function &addWorksheet($name = '')
    {
        ...
        $worksheet = new Ies_Spreadsheet_Excel_Writer_Worksheet($this->_BIFF_version,
                                   $name, $index,
    ...
    */
    ...
    {
        $format = new Ies_Spreadsheet_Excel_Writer_Format($this->_BIFF_version, $this->_xf_index, $properties);
        $this->_xf_index += 1;
    ...
    function &addValidator()
    {
        ...
        $valid = new Ies_Spreadsheet_Excel_Writer_Validator($this->_parser);
        return $valid;
    }
...
/*        if ($this->isError($res)) {
    ...
    */
    ...
    {
        $OLE = new Ies_OLE_PPS_File(Ies_OLE::Asc2Ucs('Book'));
        if ($this->_tmp_dir != '') {
        ...
        $root = new Ies_OLE_PPS_Root(time(), time(), array($OLE));
        if ($this->_tmp_dir != '') {
