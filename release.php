 ...
 * @version     $Id: release.php,v 1.1 2010/04/13 21:55:55 hyokos Exp $
 */
...
define('TINE20_TITLE', 'Vulcan 1.0');
...
$build = '2010-03-ms2-1' . ' '. Zend_Date::now()->get(Tinebase_Record_Abstract::ISO8601LONG);
...
function concatJs(array $_files, $_filename)
{
    ...
    foreach ($_files as $file) {
        ...
        if (file_exists("$tine20path/$filename")) {
            ...
            $jsContent = preg_replace('/Tine\.clientVersion\.codeName.*;/i',      "Tine.clientVersion.codeName = '';", $jsContent);
            ...
            $jsContent = preg_replace('/Tine\.clientVersion\.packageString.*;/i', "Tine.clientVersion.packageString = '2010-03-ms2-1';", $jsContent);
