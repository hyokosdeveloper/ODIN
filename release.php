 ...
 * @version     $Id: release.php,v 1.1 2009/12/08 23:15:25 hyokos Exp $
 */
...
$build = '2009-07-7' . ' '. Zend_Date::now()->get(Tinebase_Record_Abstract::ISO8601LONG);
...
function concatJs(array $_files, $_filename)
{
    ...
    foreach ($_files as $file) {
        ...
        if (file_exists("$tine20path/$filename")) {
            ...
            $jsContent = preg_replace('/Tine\.clientVersion\.codeName.*;/i',      "Tine.clientVersion.codeName = 'Leonie (2009/07)';", $jsContent);
            ...
            $jsContent = preg_replace('/Tine\.clientVersion\.packageString.*;/i', "Tine.clientVersion.packageString = '2009-07-7';", $jsContent);
